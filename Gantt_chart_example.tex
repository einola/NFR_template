...
\begin{figure}
    ...
    \end{ganttchart}
    \caption{A Gant chart using the default formatting. Milestones are indicated with diamonds and deliverables with stars.}
\end{figure}
...
\begin{figure}
    ...
    \begin{ganttchart}[
        ...
        \ganttlink{milestone1.2}{task2.2}
    \end{ganttchart}
    \caption{A Gant chart using some fancy formatting. Milestones are indicated with diamonds and deliverables with stars.}
\end{figure}
